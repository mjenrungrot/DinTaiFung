...
def generate_sample(args: argparse.Namespace,
    ...
    Steps:
    - [1] Sample background with the same length as voice.
    - [2] Pick background location with r in [2.0, 5.0)
    - [3] Create a scene
    - [4] Render sound
    - [5] Save metadata
    """
...
def main(args: argparse.Namespace):
    ...
    base_voice, _ = librosa.core.load(args.input_voice_path, sr=args.sr, mono=True)
    ...
    for i in range(args.n_outputs):
        pool.apply_async(generate_sample,
                         args=(args, base_voice, base_background, args.sr, i),
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_voice_path', type=str, default="base_voice.wav")
...
python generate.py \
    --output_path /projects/grail/audiovisual/datasets/DinTaiFung/simple_1_voice_1_bg_hard/train \
    --bg_factor 10.0 \
    --n_outputs 10000
python generate.py \
    --output_path /projects/grail/audiovisual/datasets/DinTaiFung/simple_1_voice_1_bg_hard/test \
    --bg_factor 10.0 \
    --n_outputs 2000
"""